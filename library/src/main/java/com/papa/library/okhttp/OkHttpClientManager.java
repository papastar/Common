...
public class OkHttpClientManager {
        ...
        mOkHttpClient.newCall(request).enqueue(new Callback() {
            ...
            public void onResponse(final Response response) {
                ...
                if (response.code() >= 400 && response.code() <= 599) {
                    try {
                        sendFailResultCallback(request, new RuntimeException(response.body()
                                .string()), resCallBack);
                    } catch (IOException e) {
                        e.printStackTrace();
                    }
                ...
                try {
                    ...
                    OkHttpUtil.logRequestUrl(response.request().urlString());
                    OkHttpUtil.logResponse(string);
    ...
    public void sendFailResultCallback(final Request request, final Exception e, final
    ResultCallback callback) {
        if (callback == null) return;
        OkHttpUtil.logResponseFail(e, request.urlString());
