...
// KEEP INCLUDES END
/**
 * Entity mapped to table "HOTEL_COMMERCIAL".
 */
public class HotelCommercial {
    ...
    private transient HotelCommercialDao myDao;
    ...
    public HotelCommercial() {
    }

    public HotelCommercial(Long id) {
        this.id = id;
    }

    public HotelCommercial(Long id, String name, Long cityId) {
        this.id = id;
        this.name = name;
        this.cityId = cityId;
    }
    ...
    public void __setDaoSession(DaoSession daoSession) {
        ...
        myDao = daoSession != null ? daoSession.getHotelCommercialDao() : null;
    }
